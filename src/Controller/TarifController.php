...
class TarifController extends AbstractController
{
    ...
    public function new(Request $request, TarifRepository $tarifRepository): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('app_tarif_new', [], Response::HTTP_SEE_OTHER);
        }
    ...
    {
  /*       //dd($tarif->getTemps()->format('h:i:s'));
        $dateValable = $tarif->getTemps()->format('Y-m-d H:i:s');
        $dateValable->modify('+1 hour'); */
